    ...
    <div class="logo w1210">
        ...
        <div class="user fl">
            <dl>
                ...
                <dd>
                    <div class="prompt">
                        您好，请<a href="<?=\yii\helpers\Url::to(['goods/index'])?>">登录</a>
                    </div>
    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
            ...
            <div class="preview fl">
                <div class="midpic">
                    <a href="http://admin.yiishop.com<?=$gallery[0]->path?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
                        <img src="http://admin.yiishop.com<?=$gallery[0]->path?>" alt="" />               <!-- 第一幅图片的中图 -->
                    </a>
                </div>
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        ...
                        <ul>
                            ...
                            <li class="cur">
                                <a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'http://admin.yiishop.com<?=$logo->path?>',largeimage: 'http://admin.yiishop.com<?=$logo->path?>'}"><img src="http://admin.yiishop.com<?=$logo->path?>"></a>
                            </li>
                            <?php endforeach;?>
                        </ul>
