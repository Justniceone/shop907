...
<?php foreach ($goods as $good):?>
        <tr data-id="<?=$good->id?>">
            <td class="col1"><a href="<?=\yii\helpers\Url::to(['goods/detail?id='.$good->id])?>"><img src="http://admin.yiishop.com<?=$good->logo?>" alt="" /></a>  <strong><a href=""><?=$good->name?></a></strong></td>
            <td class="col3">￥<span><?=$good->shop_price?></span></td>
            <td class="col4">
                <a href="javascript:;" class="reduce_num"></a>
                <input type="text" name="amount" value="<?=$arrays[$good->id]?>" class="amount"/>
