...
<div class="main w1210 bc mt10">
    ...
    <div class="content fl ml10">
        <div class="address_hd">
            <h3>收货地址薄</h3>
            <?php foreach (\frontend\models\Address::AddressExcept() as $address):?>
            ...
            <form action="" method="post" name="address_form">
                <ul>
                    <li>
                        ...
                        <input type="text" name="username" class="txt" value="<?=$model->username?>" />
                    </li>
                    ...
                    <li>
                        <label for=""></label>
                        <input type="checkbox" name="is_default" class="check" <?=$model->is_default?'checked':''?>/>设为默认地址
                    </li>
                    <li>
                        <label for=""></label>
